    ...
    public class Heroe
    {
        ...
        protected Circle heroe;
        protected int hidingBuilding;
        protected double posicionY;
        protected double posicionX;
        protected int h;
        protected double vox=0;
        protected double voy=0;    
        protected double vo;   
        protected double y;
        protected double PosiXParaHero;
        protected double PosiYParaHero;
        protected double x;
        protected double t=0;
        protected ArrayList<Circle>ListaHeroes;
        protected ArrayList<Rectangle>ListaVitalidad;
        protected ArrayList<String> ColoresHeroes;
        protected  boolean isVisible;
        protected Rectangle vitalidad;
        protected  ArrayList<Rectangle>vidasHeores= new ArrayList<Rectangle>();
        protected boolean heroeMuerto=false;
        protected boolean varibleBool=false;
        protected int posiActEdiX;
        protected int edificioHeroeAncho;
        protected int strengthIsSafeJump;
        protected boolean modoIsJumpNoSeguro=true;
        protected boolean sobreviveHeroeEdi=false;
        protected int strenghtt2;
        protected boolean modoIsJumpOn=false;
        protected int nuevaAlturaEdificio;
        protected int posiEdiModificado=-1;
        protected boolean veriHeroNoMuerto=false;
        protected int anchoVitalidad=30;
        protected ArrayList<Integer>listaPlan;
        protected boolean encimaEdificio=false;
        protected int numeroEdificio;
        protected int EdificiosDañado= -1000000;
        protected boolean hereoEnEdiRoto = false;
        /**
         * Constructor Heore
         *
         * @param  color
        ...
        /**
                 ...
                 */
        public void BorraHeroe(String color)
        {
         ...
         * @return boolean
         */
        public boolean verificaChoqueXEdificio(Hashtable infCoordenadas,double x,double y,ArrayList posicionesX,int altoCanvas,
        Hashtable durezasEdificios, Hashtable infCoordenadasAncho)
        {
            ...
            */
            public boolean chocoEdificio(double x,double y,int altoCanvas,int anchoCanvas,Hashtable infCoordenadas,
    ...
    /** Move the heroe in form of parabolic
        ...
        * @return choque booleano 
        */
            public boolean chocoEdificio2(double x,double y,int altoCanvas,int anchoCanvas,Hashtable infCoordenadas,
            String color,ArrayList posicionesX,Hashtable durezasEdificios,Hashtable infCoordenadasAncho)
            {
                if (y>=altoCanvas-15){
                   varibleBool=false;
         ...
         * @return boolean
         */
        public boolean verificaChoqueXEdificio2(Hashtable infCoordenadas,double x,double y,ArrayList posicionesX,int altoCanvas,
        Hashtable durezasEdificios, Hashtable infCoordenadasAncho)
        {
           ArrayList<Integer>posicionesX2 = posicionesX;
            for(Integer i : posicionesX2){
        ...
        public boolean chocoEdificio3(double x,double y,int altoCanvas,int anchoCanvas,Hashtable infCoordenadas,
            String color,ArrayList posicionesX,Hashtable durezasEdificios,Hashtable infCoordenadasAncho)
            {
                if (y<=0){
                   return true;                    
