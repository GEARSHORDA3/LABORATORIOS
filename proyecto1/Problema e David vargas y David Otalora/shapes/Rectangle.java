...
public class Rectangle{
    ...
    public void changeSize(int newHeight, int newWidth) {
        ...
        height = newHeight;
        width = newWidth;
        System.out.println(height+"aaaaaaaaaaaaaa");
        System.out.println(width +"aaaaaaaaaaaaaaa");
        draw();
    }
    ...
    private void draw() {
        if(isVisible) {
            ...
            System.out.println(getWidth()+"rectangleancho");
            System.out.println(getHeight()+"rectanglealto");
    ...
    private void erase(){
        if(isVisible) {
            Canvas canvas = Canvas.getCanvas(700,700);
            canvas.erase(this);
        }
    }
}
