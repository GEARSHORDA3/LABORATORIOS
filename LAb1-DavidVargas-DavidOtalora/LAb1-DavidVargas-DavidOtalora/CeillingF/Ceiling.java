 import javax.swing.ImageIcon;
            ...
            public class Ceiling 
            {
               ...
               public Ceiling(int[] P, String color) {
                   //No se permite adicionar techos con las mismas capas  
                   ArrayList<Integer> p= new ArrayList<Integer>(); 
                   boolean Error=false;
                   for(int algo=0; algo<P.length;algo++){
                       p.add(P[algo]);
                   } 
                   for (int valor=0; valor<p.size();valor++){
                       for (int valor2=0;valor2<lista4.size();valor2++){
                           if (p.get(valor)==lista4.get(valor2)){
                               p.remove(valor);
                               Error=true;
                            }
                       }
                   ...
                   if (Error==true){
                       Toolkit.getDefaultToolkit().beep();
                       JOptionPane.showMessageDialog(null, "No se pueden agregar techos con los mismos capas");                       
                    }
                   ...
                   if (tamaño==5){
                       ...
                       Rect.changeHeightWidth(53*p.size());
                       ...
                       int posicion=(52*p.size())-50;
                       int i;
                
                       for (i=0; i<(p.size()); i++){
                          Rectangle Rect2= new Rectangle();
                          Rect2.changeColor(colors.get(p.get(i)));
                ...
                */ 
                public void RandomColor(){
                   ...
                   for (int i2=0; i2<lista3.size();i2++){
                       int n = rand.nextInt(9) + 0;
                       lista3.get(i2).changeColor(colors.get(n));
                   }
                } 
               /**
                 * Add the top part of the roof.
               ...
               public void add(int m){
                   ...
                   if (itera==false){
                       itera=true;
                       MaxCantidad=lista4.size();
                    }
                   if (MaxCantidad==10){
                       Toolkit.getDefaultToolkit().beep();
                       JOptionPane.showMessageDialog(null, "No se pueden agregar mas capas");                       
                   }
                   else{
                       MaxCantidad+=1;
                ...
                */ 
                public void showCeil(){
                       ...
                       //Hacer visible rectangulo fondo
                       Rectangle Rect= new Rectangle();
                       Rect.changeHeightWidth(53*lista4.size());
                       Rect.changeColor(color);
                       this.color=color;
                       ...
                       for (i=0; i<(lista4.size()); i++){
                          Rectangle Rect2= new Rectangle();
                          Rect2.changeColor(colors.get(lista4.get(i)));
                          Rect2.changeSize(40,100);
                          Rect2.moveHorizontal(10);
                          Rect2.moveVertical(posicion);
                          Rect2.moveHorizontal(x);
